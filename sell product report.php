...
<div class="row">
  ...
  <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Sell Product of  <?Php echo $firstname; ?></h5>
				<div class="col-6">
	...
	<td><input type="text" class="form-control" name="res" list="datalist1" value="<?php echo $firstname ?>">
			  ...
			  <div class="table-responsive">
				...
				$todatey=date("Y-m-d", strtotime($todatex));
			    $firstname=$_POST['res'];
$sql="select * from sellproduct where todaydate>= '$fromdatey' && todaydate<= '$todatey' && Employeename='$firstname'";
$result=mysqli_query($conn,$sql);
				while($idsh=mysqli_fetch_object($result))
				{
					
					$leadno=($idsh->leadnumber);
