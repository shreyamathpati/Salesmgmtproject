...
$result=mysqli_query($conn,$sql);
				...
				{
					$id=($idsh->id);
					$Customer_name=($idsh->Cutomername);
					...
					$BrandName=($idsh->Brand_name);
					$ModelNo=($idsh->Model_no);
					$Rate=($idsh->Rate);
				}
...
$sql="UPDATE customer_details SET Cutomername='$Customer_name', Mobileno='$Mobileno',Address='$Address',City='$City',State='$State',Postal_code='$PostalCode',Email_id='$YourEmail',Organization_name='$OrganizationName',Brand_name='$BrandName',Model_no='$ModelNo',Rate='$Rate' WHERE id='$id'";
            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="brandname" class="form-control" value="<?php echo $BrandName?>">
                      <div class="invalid-feedback">Please, enter your brand name!</div>
                    </div>
					
					<div class="col-12">
                      <label for="youModelno" class="form-label">Model No</label>
                      <input type="text" name="Modelno" class="form-control" value="<?php echo $ModelNo?>">
