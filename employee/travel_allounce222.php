...
$sql="insert into travel_allounce (emp_name,image,amount,details) 
VALUES ('$Employeename','$nn','$Amount','$Details')";
            ...
            <div class="card-body">
              <h5 class="card-title">Quotation</h5>
                  ...
                  <div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourbrandName" required>
