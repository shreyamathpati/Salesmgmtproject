...
$sql="select * from sellproduct where brand = '$brandname' &&  Employeename = '$firstname'";
...
$sql="select * from sellproduct where todaydate>= '$fromdatey' && todaydate<= '$todatey' && brand = '$brandnameabc' &&  Employeename = '$firstname'";
$result=mysqli_query($conn,$sql);
				while($idsh=mysqli_fetch_object($result))
				{
