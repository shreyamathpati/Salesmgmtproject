...
<div class="row">
  ...
  <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">My History Details <?PHP echo $firstname; ?></h5>
				<div class="col-6">
			  ...
			  <div class="table-responsive">
				...
				$sql="select * from followup where Followupdate>= '$fromdatex' && Followupdate<= '$todatex' && employee_name='$firstname'  ";
$result=mysqli_query($conn,$sql);
				while($idsh=mysqli_fetch_object($result))
				{
					...
					$citya=($idsh->City);
					$notea=($idsh->Note);
				    $fromdatex=($idsh->C_date);
					$todatex=($idsh->Followupdate);
					$estatus=($idsh->EmployeeStatus);
				...
				<tr>
					...
					<td><?php echo $fromdatex?></td>
					<td><?php echo $todatex?></td>
