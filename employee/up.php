...
$rate=$_POST['Rate'];
	...
	$sql="UPDATE into customer_process SET Cutomer_name='$customername',Address='$Address',City='$city',State='$state',Postal_code='$postalcode',Email_id='$email',Organization_name='$organizationname',Brand_name='$brandname',Model_no='$modelno',Rate='$rate' WHERE id='$id'";
          ...
          <div class="card">
            ...
            <table class="table table-borderless">
             ...
             <td><?php echo $id?></td>
					...
					<td><a href="update_customer.php">Select</a></td>
