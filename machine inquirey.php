...
if(isset($_POST['add1']))
{
	 ...
	 $sqla="delete from  machine_inquirey WHERE id='$dels'";
if(mysqli_query($conn,$sqla))
 ...
 {
//echo alert("Error to delete the item");
 }
}
?>
			   ...
			   <table class="table table-bordered">
                <thead>
				 ...
				 $idb=($idsh->id);
				   ...
				   <td><?php echo $rate ?></td>
				   <td><button type="submit" name="add1" value="<?php echo $idb ?>" class="btn btn-secondary btn-sm">Delete</button>
				   </td>
				   </tr>
				   <?php
				   }
