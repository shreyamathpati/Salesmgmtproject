...
<td><input type="text" class="form-control" name="brandname" list="datalist3" value="<?php echo $Brandname ?>">
					...
					{
					$brandname=stripslashes($rs->Brandname);
...
$sql="select * from sellproduct where todaydate>= '$fromdatey' && todaydate<= '$todatey' && brand = '$brandname' &&  Employeename = '$firstname'";
