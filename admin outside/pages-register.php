            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">ZoomInfo And Memonto</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Account For Sales</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
					...
					<div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourLName" required>
					...
					<div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourNumber" required>
					...
					<div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourBlood" required>
					...
					<div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourFcontact" required>
                      <div class="invalid-feedback">Please, enter contactno!</div>
                    </div>
					
					<div class="col-12">
                      <label for="yourJoin" class="form-label">Joining date</label>
                      <input type="date" name="name" class="form-control" id="yourJoin" required>
                      <div class="invalid-feedback">Please, enter contactno!</div>
                    </div>
