  ...
  <main id="main" class="main">
    ...
    <div class="row">
     ...
     <div class="col-lg-6">
      ...
      <h5 class="card-title">Product Wise Report</h5>
      <h2 class="card-title">Brand Name</h2>
              
              <form class="row g-3" method="POST">
                <div class="col-md-12">
                  <input type='text' value = "<?php echo $brandname ?>" name="brandname" class="form-control" >
                </div>
			  
				<div class="text-center">
                  <button type="submit" class="btn btn-primary" name="savea">Show</button>
				</div>
                <table class="table">
				<tr>
